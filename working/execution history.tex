...
Modern computational theory frequently treats programs as static objects
whose meaning is defined by membership relations over sets of states.
However, real systems operate through irreversible event histories
rather than timeless collections.

This essay proposes a minimal operational kernel in which
\textit{event histories constitute the primary structure of computation},
while state and abstraction emerge as derived reductions of those histories.
Within this framework, computation proceeds through the irreversible
extension of histories by events, the composition of compatible histories
through merge operations, and the reduction of histories through controlled
loss of information.

From these operations arise deterministic replay,
log-structured computation, and forms of execution governed by
locally propagated constraints.

The framework therefore replaces set-theoretic membership
with replayable construction histories, providing a unified
account of execution, composition, and abstraction in both
computational and physically constrained systems.
